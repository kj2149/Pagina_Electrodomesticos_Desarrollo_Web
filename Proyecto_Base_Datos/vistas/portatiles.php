...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="../css/icono.css">  -->   
	...
	<title>Portatiles - Unlimited Tecnhology</title>
</head>
			...
			<li class="toproot"><a href="#" target="marco"style="height:28px;line-height:22px;"><span>Productos</span></a>
				<ul>
					...
					<ul style="left:150px;">	
						...
						<li><a href="../vista/repuestosphpl">Repuestos</a></li>
...
<!--/////////////          Contenido         //////////////-->
		...
		<article>
		    <img id="til" src="../imagenes/tit-cel.png" alt="celulares">
				<ul>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen62.jpg">
						<p>Portatil Asus X409ma-bv155t Celeron/4gb/500gb/w10<br>
						$1.449.900</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen63.png">
						<p>Portatil Asus X409ja-ek019t Core I3/256gb Ssd/4gb/w10<br>
						$1.699.900</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen64.png">
						<p>Portátil ASUS VivoBook M433IA-EB117T AMD Ryzen 5 14" Pulgadas<br>
						$ 2.799.000</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen65.png">
						<p>Portatil Asus X409MA-BV176 Intel Celeron N4020 1 Tb 4gb Endless<br>
						$1.399.000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen66.png">
						<p>Portátil Gamer ACER AN515-54-53GZ Intel Core i5 15.6 Pulgadas 8GB RAM Disco Duro 1TB Negro<br>
						$ 3.339.000</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen67.jpg">
						<p>Computador Portátil Gamer ROG Zephyrus Duo 15 - 15,6" Pulgadas GX550LXS-HC106T Procesador Intel Core i9 <br>
						$19,599,000</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen68.jpg">
						<p>QERE 15.6 pulgadas Portátiles 8GB RAM 256G SSD Cuerpo de metal 1080P Win10 OS<br>
						$1,450,000</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen56.jpg">
						<p>Hp Omen Portatil Gamer Amd Ryzen 7 4800h 8gb Ram Gtx 1660ti<br>
						$3,100,000</p></li>
                </ul>           
		</article>
	</section>
