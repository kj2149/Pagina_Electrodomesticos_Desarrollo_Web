...
<head>
  ...
  <title>Unlimited Tecnhology - producto 54</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
     <h1> Board Asus Rog Strix B450 F Gaming Amd </h1>
     <div class="producto">
        <img src="../imagenes/imagen54.png">
     </div>
<!-------------------------------- caja de informacion del producto ----------------------------->
<div class="info_producto">
          
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 640.000 </p>
      <p class="precio_especial"> Hoy $ 629.000 </p> 
 ...
 <!-------------------------------- especificaciones del producto ----------------------------->
    <div class="tab-content">
      ...
      <tr>
        ...
        <td class="tede"> ASUS </td>
      </tr>

        <tr >
        <th class="teache"> Zócalo de CPU </th>
        <td class="tede"> Socket TR4 </td>
      </tr>
      ...
      <tr>
        ...
        <td class="tede"> AMD 2nd Gerenration Ryzen, AMD Athlon </td>
      </tr>

       <tr>
        <th class="teache"> Tipo De Set De Chips </th>
        <td class="tede"> AMD B450 </td>
      </tr>
      ...
      <tr>
        ...
        <td class="tede"> Windows 10 </td>
      </tr>

      <tr>
        <th class="teache"> Series </th>
        <td class="tede"> ROG STRIX B450-F GAMING </td>
      </tr>

      <tr>
        <th class="teache"> Capacidad De Almacenamiento De Memoria </th>
        <td class="tede"> 64 GB </td>
      </tr>

      <tr>
        <th class="teache"> Interfaz De Tarjeta De Gráficos </th>
        <td class="tede"> Integrado </td>
      </tr>
      
      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> Experience next level performance with the ROG Strix B450 F Gaming, powered by 2nd generation AMD Ryzen AM4 processors. Unlock your system's potential with 5 Way Optimization featuring Fan Xpert 4 while personalizing your build with Aura Sync RGB. Integrated NVMe M.2, gigabit LAN and USB 3.1 Gen2 deliver maximum connectivity speeds. </td>
      </tr>
