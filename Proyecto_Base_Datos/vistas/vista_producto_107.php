...
<head>
  ...
  <title>Unlimited Tecnhology - producto 107</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
     <h1> Procesador Celeron G4930 9na Gen </h1>
      
     <div class="producto">
        <img src="../imagenes/imagen107.png">
     </div>
...
<div class="info_producto">
  ...
  <div class="detalles_producto">
    <p>      
  El procesador Intel Celeron G4930 ofrece un buen rendimiento gracias a su frecuencia nativa de 3,2 GHz, 2 núcleos y 2 hilos, 2 MB de caché y 8GT/s de sistema BUS. Con una envolvente térmica máxima (TDP) de sólo 54W, logra la hazaña de ofrecer altas frecuencias de funcionamiento para reducir el consumo de energía.
 ...
 <!-------------------------------- Especificaciones del producto ----------------------------->
    <div class="tab-content">
      ...
      <tr>
        <th class="teache"> Designacion </th>
        <td class="tede"> Intel Celeron G4930 (3,2 GHz) </td>
      </tr>
      ...
      <tr>
        <th class="teache"> Modelo De Procesador </th>
        <td class="tede"> Intel Celeron </td>
      </tr>

       <tr>
        <th class="teache"> Soporte Del Procesador </th>
        <td class="tede"> Intel 1151 </td>
      </tr>

      <tr>
        <th class="teache"> Frecuencia CPU </th>
        <td class="tede"> 128 GB </td>
      </tr>

      <tr>
        <th class="teache"> Frecuencia Del Bus </th>
        <td class="tede"> DMI 8.0 GT/s </td>
      </tr>

      <tr>
        <th class="teache"> Numero De Core </th>
        <td class="tede"> 2 </td>
      </tr>

      <tr>
        <th class="teache"> Numero De Threads </th>
        <td class="tede"> 2 </td>
      </tr>

      <tr>
        <th class="teache"> Plataforma (Proc.) </th>
        <td class="tede"> Intel Coffee Lake </td>
      </tr>

      <tr>
        <th class="teache"> Controlador Memoria </th>
        <td class="tede"> DDR4 </td>
      </tr>

      <tr>
        <th class="teache"> Tipo De Controlador Memoria </th>
        <td class="tede"> Dual Channel </td>
      </tr>

      <tr>
        <th class="teache"> Gamer </th>
        <td class="tede"> NO </td>
      </tr>

      <tr>
        <th class="teache"> Ventilador suministrado </th>
        <td class="tede"> SI </td>
      </tr>

      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> Los procesadores Intel Celeron están diseñados para la informática cotidiana. Simple y eficiente, se basan en una alta frecuencia nativa, 2 núcleos físicos y 2 núcleos lógicos, 2 MB de memoria caché L3 y un controlador gráfico Intel UHD Graphics 610..</td>
      </tr>
