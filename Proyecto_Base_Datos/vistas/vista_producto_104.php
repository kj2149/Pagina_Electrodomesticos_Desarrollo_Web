...
<head>
  ...
  <title>Unlimited Tecnhology - producto 104</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
     <h1> Procesador Amd Ryzen 5 3600 6 Núcleos 12 Hilos </h1>
      
     <div class="producto">
        <img src="../imagenes/imagen104.png">
     </div>
<!-------------------------------- caja de informacion del producto ----------------------------->
<div class="info_producto">
          
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 980.000 </p>
      <p class="precio_especial"> Hoy $ 914.999 </p> 
  ...
  <div class="detalles_producto">
    <p>      
  Es ideal para jugadores y creadores de contenido que requieran un instrumento de gran ejecución. <br>
  Memoria caché de 32 MB, rápida y volátil. <br>
...
<!-------------------------------- Especificaciones del producto ----------------------------->
    ...
    <div class="tab-content">
      ...
      <tr>
        ...
        <td class="tede"> AMD </td>
      </tr>

        <tr >
        <th class="teache"> Línea </th>
        <td class="tede"> Ryzen 5 </td>
      </tr>

      <tr>
        <th class="teache"> Modelo </th>
        <td class="tede"> 3600 </td>
      </tr>

      <tr>
        <th class="teache"> Modelo Alfanumérico </th>
        <td class="tede"> 100-100000031BOX </td>
      </tr>

       <tr>
        <th class="teache"> Tipos De Memoria RAM Soportadas </th>
        <td class="tede"> DDR4 </td>
      </tr>

      <tr>
        <th class="teache"> Tamaño Máximo De Memoria RAM Soportada </th>
        <td class="tede"> 128 GB </td>
      </tr>

      <tr>
        <th class="teache"> Accesorios incluidos </th>
        <td class="tede"> Air cooler </td>
      </tr>

      <tr>
        <th class="teache"> Frecuencia Mínima / Maxima De Reloj </th>
        <td class="tede"> 3.6 GHz / 4.2 GHz </td>
      </tr>
      ...
      <tr>
        <th class="teache"> Zócalos Compatibles </th>
        <td class="tede"> AM4 </td>
      </tr>

      <tr>
        <th class="teache"> Arquitectura </th>
        <td class="tede"> x86-64 </td>
      </tr>

      <tr>
        <th class="teache"> Cantidad De Núcleos De CPU </th>
        <td class="tede"> 128 Bits </td>
      </tr>

      <tr>
        <th class="teache"> Cantidad de hilos de CPU </th>
        <td class="tede"> 6 </td>
      </tr>

      <tr>
        <th class="teache"> Potencia De Diseño Térmico </th>
        <td class="tede"> 65 W </td>
      </tr>

      <tr>
        <th class="teache"> Es OEM </th>
        <td class="tede"> NO </td>
      </tr>

      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> * Es ideal para jugadores y creadores de contenido que requieran un instrumento de gran ejecución.<br>
       Cuenta con 12 hilos que favorecen la ejecución de múltiples programas a la vez. <br>
       rocesador innovador desarrollado bajo altos estándares de calidad.</td>
      </tr>
