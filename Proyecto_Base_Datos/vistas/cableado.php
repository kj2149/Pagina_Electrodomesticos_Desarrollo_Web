...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="../css/icono.css">  -->   
	...
	<title>Cableado - Unlimited Tecnhology</title>
</head>
...
<!--/////////////    Contenido       //////////////-->
	...
	<section class="container-contenido">
		<article>
		    <img id="til" src="../imagenes/tit-cab.png" alt="cableado">
	     		<ul>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen41.jpg">	
						<p>Propack 3 Rollos de Alambre N12 X 100M Blanco<br>
							$366.900</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen42.jpg">	
						<p>Alambre N10 100M Negro Nexans<br>
							$210.900</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen43.jpg">	
						<p>Nexans Alambre #10 100m Color Rojo<br>
							$210.900</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen44.jpg">	
						<p>Alambre #12 100 metros negro Conectores y Cables<br>
							$124.900</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen45.jpg">	
						<p>Nexans Alambre #14 100m Color Verde<br>
							$89,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen46.jpg">	
						<p>Procables Alambre N12 100mt Propack 4und (1AMAR 1BCO 1RJO 1VDE)<br>
							$489,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen47.jpg">	
						<p>Procables Alambre N12 100mt Propack 4und (1NEG 1BCO 1VDE 1AZUL)<br>
							$460,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen48.jpg">	
						<p>Alambre #14 100 metros amarillo Conectores y Cables<br>
							$88.900</p></li>
				</ul>			
		</article>
	</section>
