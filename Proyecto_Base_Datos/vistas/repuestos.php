...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="../css/icono.css">  -->   
	...
	<title>Repuestos - Unlimited Tecnhology</title>
</head>
	...
	<header>
     ...
     <!--BUSCADOR-BOTONES INICIO , REGISTRAR-->
	          ...
	          <div class="buscar1">
		            ...
		            <a class="registrar1" href="../vistas" > <button type="button" class="bot-log-reg">Registrarse</button></a>
              </div>
		    ...
		    <img id="til" src="../imagenes/tit-cel.png" alt="repuestos">
				...
				<ul>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen33.jpg">	
						<p>DISIPADOR COOLER MASTER FAN MF120R ARGB<br>
						$49,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen34.jpg">	
						<p>DISIPADOR COOLER MASTER HPER H410R RGB<br>
						$149,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen35.jpg">	
						<p>DISIPADOR COOLER MASTER HYPER 212RGB<br>
						$290,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen36.jpg">	
						<p>BASE PARA PORTATIL J&R BRJR-009 RECLINAJ 2FAN<br>
						$50,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen37.jpg">	
						<p>BATERIA PC ACER 10.8V/2200MHZ 1410 1810T 1810TZ <br>
						$149,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen38.jpg">	
						<p>BATERIA PC ACER ONE 11.6P 9CEL-11.1-7800MHA<br>
						$289,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen39.jpg">	
						<p>BATERIA PC DELL 1525/1540 11.1/4400MAH PREM<br>
						$160,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen40.jpg">	
						<p>BATERIA PC DELL 2500/3700/3800<br>
						$198,000</p></li>
		        </ul>   
		</article>
	</section>
