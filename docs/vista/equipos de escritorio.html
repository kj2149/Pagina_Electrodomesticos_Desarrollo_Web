...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="../css/icono.css">  -->   
	...
	<title>Equipos de Escritorio - Unlimited Tecnhology</title>
</head>
	...
	<section class="container-contenido">
		<article>
		    <img id="til" src="../imagenes/tit-cel.png" alt="celulares">
				<ul>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen70.jpg">
						<p>Pc Intel Core I5 9gen - 8gb - 1 Tera Mon 19.5 Teclado+mouse<br>
						$$2.239.000</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen71.png">
						<p>Computador HP ProDesk 400 G6 Ci7 19" Pulgadas RAM 8 GB Disco Duro<br>
						$ 3.549.000</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen72.jpg">
						<p>Torre HP TG01-101BLA Gaming CI3 8GB 1TB 2GB+Monitor<br>
						$2.999.000</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen73.jpg">
						<p>Pc Torre Gamer Amd Ryzen 3 3200G Disco Ssd 240Gb Ram 8gb Monitor 22"<br>
						$2.049.000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen74.jpg">
						<p>PC GAMER IMMORTALS CORE I5 9400F H310M SSD 240GB RAM 8GB<br>
						$2.599.899</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen75.jpg">
						<p>Pc De Mesa Core I7 1tb 16 Gb Ddr4 Monitor Samsung 22 Raedon<br>
						$4.999.999</p></li>
                          
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen76.jpg">
						<p>4 colores 2 niveles Computadora de escritorio de madera multifunción <br>
						$1,450,000</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen77.jpg">
						<p>PC DESKTOP PRODESK 600 G1 CI5 4TH + LCD"20"<br>
						$769.900</p></li> 
		        </ul>
		</article>
	</section>
