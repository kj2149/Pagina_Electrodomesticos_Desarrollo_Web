...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="../css/icono.css">  -->   
	...
	<title> Combo Teclado + Mouse - Unlimited Tecnhology</title>
</head>
	...
	<section class="container-contenido">
		<article>
		    <img id="til" src="../imagenes/tit-cel.png" alt="celulares">
				<ul>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen57.jpg">
						<p>Combo Teclado Y Mouse Cooler Master Ms111 Rgb<br>
						$279,000</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen60.jpg">
						<p>Combo Teclado + Mouse Gamer T21 Multicolor Soporte Celular<br>
						$184,000</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen61.jpg">
						<p>Combo Mouse + Teclado Seisa<br>
						$70,000</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen54.jpg">
						<p>Board Asus Rog Strix B450 F Gaming Amd<br>
						$620,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen55.jpg">
						<p>Combo Intel 10th Gen I3 10100 + Board B460 + Memoria 16gb<br>
						$1,450,000</p></li>
                   
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen56.jpg">
						<p>Combo Amd Ryzen 7 3700x + Board B550 + Memoria Ram 32gb<br>
						$3,100,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen58.jpg">
						<p>COMBO TECLADO Y MOUSE GAMER 7 COLORES XTRIKE ME<br>
						$79,900</p></li>
		  			<li class="colimag"><img id="imagen" src="../imagenes/imagen59.jpg">
						<p>Combo Ultra Gamer Full Mouse+teclado+pad Gamer<br>
						$98,900</p></li>
				</ul>
		</article>
	</section>
