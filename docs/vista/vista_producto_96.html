...
<head>
  ...
  <title>Unlimited Tecnhology - producto 96</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
    <h1> Tarjeta De Video Gigabyte Geforce Gt710 Ddr5 </h1>
      
     <div class="producto">
        <img src="../imagenes/imagen96.png">
     </div>
...
<div class="info_producto">
    ...
    <div class="caja_precio">
      ...
      <p class="precio_especial"> Hoy $ 275.000 </p> 
  ...
  Contectividad: DVI-I / HDMI I EVGA
.
    ...
    <div class="tab-content">
      ...
      <tr>
        ...
        <td class="tede"> GeForce® GT 710 </td>
      </tr>

        <tr >
        <th class="teache"> I / O </th>
        <td class="tede"> DVI-I * 1 / HDMI * 1 de doble enlace
 </td>
      </tr>
      ...
      <tr>
        <th class="teache"> Tecnología De Proceso  </th>
        <td class="tede"> Reloj de memoria de 28 nm 5010 MHz </td>
      </tr>

       <tr>
        <th class="teache"> Tamaño de memoria </th>
        <td class="tede"> 2 GB </td>
      </tr>

      <tr>
        <th class="teache"> Tipo De Memoria </th>
        <td class="tede"> DDR5 </td>
      </tr>

      <tr>
        <th class="teache"> Bus De Tarjeta </th>
      ...
      <tr>
        <th class="teache">Multi-view </th>
        <td class="tede"> 2 </td>
      </tr>

      <tr>
        <th class="teache"> Accesorios  </th>
        <td class="tede"> HDMI+DVI I EVGA low profile bracket x1 </td>
      </tr>

      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> Esta tarjeta de vídeo es perfecta si quieres actualizar los gráficos de algún computador algo pasado que disponga de ranura compatible, en cuanto a potencia aunque no es mucha ya que se puede comparar con algún APU es suficiente para correr juegos como Watch_dogs, Dragon ball: xenoverse, GTA V, Sniper Elite V2, Injustice, entre otros que yo mismo eh probado combinando esta tarjeta de vídeo con un Core i5 2400, 16 GB ram, la calidad de juegos es de medio-bajo a medio, si no pides mucho esto es para ti al alcance de tu bolsillo! </td>
      </tr>
