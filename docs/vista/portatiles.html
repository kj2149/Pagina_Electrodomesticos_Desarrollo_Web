	            ...
	            <P>
					<ul>
						<li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen62.webp">
							...
							<li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen66.png">
							<h3>Portátil Gamer ACER AN515-54-53GZ Intel Core i5 15.6 Pulgadas 8GB RAM Disco Duro 1TB Negro</h3>
							<h4>$ 3.339.000</h4></li>
                            <li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen67.webp">
