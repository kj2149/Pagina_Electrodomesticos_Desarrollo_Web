...
<!--/////////////          HEAD           //////////////-->
	...
	<section>
		<article>
		    <h1 class="til">EQUIPOS DE ESCRITORIO</h1>
	            <P>
			         <ul>
						<li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen70.webp">
							<h3>Pc Intel Core I5 9gen - 8gb - 1 Tera Mon 19.5 Teclado+mouse</h3>
							<h4>$$2.239.000</h4></li>
                            <li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen71.png">
							<h3>Computador HP ProDesk 400 G6 Ci7 19" Pulgadas RAM 8 GB Disco Duro</h3>
							<h4>$ 3.549.000</h4></li>
                            <li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen72.webp">
							<h3>Torre HP TG01-101BLA Gaming CI3 8GB 1TB 2GB+Monitor</h3>
							<h4>$2.999.000</h4></li>
                            <li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen73.webp">
							<h3>Pc Torre Gamer Amd Ryzen 3 3200G Disco Ssd 240Gb Ram 8gb Monitor 22"</h3>
							<h4>$2.049.000</h4>
                            </li><li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen74.webp">
							<h3>PC GAMER IMMORTALS CORE I5 9400F H310M SSD 240GB RAM 8GB</h3>
							<h4>$2.599.899</h4></li>
                            </li><li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen75.webp">
							<h3>Pc De Mesa Core I7 1tb 16 Gb Ddr4 Monitor Samsung 22 Raedon</h3>
							<h4>$4.999.999</h4></li>
                            </li><li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen76.webp">
							<h3>4 colores 2 niveles Computadora de escritorio de madera multifunción </h3>
							<h4>$1,450,000</h4></li>
                            </li><li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen77.webp">
							<h3>PC DESKTOP PRODESK 600 G1 CI5 4TH + LCD"20"</h3>
							<h4>$769.900</h4></li>
