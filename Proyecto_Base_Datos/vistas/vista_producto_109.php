...
<head>
  ...
  <title>Unlimited Tecnhology - producto 9</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
     <center><h1> AMD Athlon™ 3000G </h1></center> <br>
      
     <div class="producto">
        <img src="../imagenes/imagen109.png">
     </div>
<!--------------------------------caja de informacion del producto ----------------------------->
<div class="info_producto">
          
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 390.000 </p>
      <p class="precio_especial"> Hoy $ 374.000 </p> 
  ...
  <div class="detalles_producto">
    <p>      
  Descripción
  Clave en el rendimiento de tu computador de escritorio, ya no tienes que pensar en cómo distribuir el tiempo y acciones porque ahora las tareas en simultáneo son posibles.
...
<!-------------------------------- Especificaciones del producto ----------------------------->
    ...
    <div class="tab-content">
      ...
      <tr >
        <th class="teache"> N.° De Núcleos De CPU </th>
        <td class="tede"> 2 </td>
      </tr>

      <tr>
        <th class="teache"> Reloj Base </th>
        <td class="tede"> 3.5GHz </td>
      </tr>

      <tr>
        <th class="teache"> Caché L3 Total </th>
        <td class="tede"> 4MB </td>
      </tr>

       <tr>
        <th class="teache"> Temperatura máx. </th>
        <td class="tede"> 95°C </td>
      </tr>

      <tr>
        <th class="teache"> N.° De Subprocesos </th>
        <td class="tede"> 4 </td>
      </tr>

      <tr>
        <th class="teache"> Caché L1 Total </th>
        <td class="tede"> 192 KB </td>
      </tr>

      <tr>
        <th class="teache"> Desbloqueados  </th>
        <td class="tede"> SI </td>
      </tr>

      <tr>
        <th class="teache"> N.° de núcleos de GPU </th>
        <td class="tede"> 3 </td>
      </tr>

      <tr>
        <th class="teache"> Caché L2 Total </th>
        <td class="tede"> 1MB </td>
      </tr>

      <tr>
        <th class="teache"> TDP/TDP Predeterminado </th>
        <td class="tede"> 35W </td>
      </tr>

      <tr>
        <th class="teache"> CMOS </th>
        <td class="tede"> 14nm </td>
      </tr>

      <tr>
        <th class="teache"> Versión de PCI Express </th>
        <td class="tede"> PCIe® 3.0 </td>
      </tr>

      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> Máxima potencia
         Al estar desbloqueado, podrás realizar overclocking y así aumentar la frecuencia de funcionamiento y optimizar el rendimiento de tu equipo. Personalízalo a tu gusto y disfruta de tus videojuegos o haz que la renderización de imágenes sea más ágil. ¡Descubre el abanico de posibilidades que esta función te ofrece!.</td>
      </tr>
