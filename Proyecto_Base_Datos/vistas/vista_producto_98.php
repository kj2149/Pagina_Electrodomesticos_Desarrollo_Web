...
<head>
  ...
  <title>Unlimited Tecnhology - producto 98title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
     <h1> Tarjeta De Video Maxsun Gt 1030 2gb Gddr5 Nvidia Geforce </h1>
      
     <div class="producto">
        <img src="../imagenes/imagen98.png">
     </div>
<!-------------------------------- caja de informacion del producto ----------------------------->
<div class="info_producto">
          
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 610.000 </p>
      <p class="precio_especial"> Hoy $ 599.000 </p> 
...
<!-------------------------------- Especificaciones del producto ----------------------------->
  <div class="detalles_producto">
    <p>      
  Fabricante: El enfriador de diseño personalizado introdujo un ventilador de 80 mm junto con la base de aluminio, que juntos brindan una capacidad de disipación de calor efectiva para un mayor rendimiento a temperaturas más bajas.
    ...
    <div class="tab-content">
      ...
      <tr>
        <th class="teache"> Procesamiento De Gráficos </th>
        <td class="tede"> GeForce® GT 1030 </td>
      </tr>

        <tr >
        <th class="teache"> Reloj De Núcleo </th>
        <td class="tede"> Boost: 1544 MHz / Base: 1290 MHz en modo OC
        Boost: 1518 MHz / Base: 1265 MHz en modo Gaming </td>
      </tr>

      <tr>
        <th class="teache"> Colores CUDA® </th>
        <td class="tede"> 384 </td>
      </tr>

      <tr>
        <th class="teache"> Reloj De La Memoria </th>
        <td class="tede"> 6008 MHz </td>
      </tr>
      ...
      <tr>
        <th class="teache"> Tipo De Memoria </th>
        <td class="tede"> GDDR5 </td>
      </tr>

      <tr>
        <th class="teache"> Bus De Memoria </th>
        <td class="tede"> 64 Bits </td>
      </tr>

      <tr>
        <th class="teache"> Resolución Máxima Digital </th>
        <td class="tede"> 4096 X 2160 </td>
      </tr>

      <tr>
        <th class="teache"> Vista Múltiple </th>
        <td class="tede"> 2 </td>
      </tr>

      <tr>
        <th class="teache"> Tamaño De La Tarjeta </th>
        <td class="tede"> Alto = 26,8 largo = 167,7 ancho = 111,2 mm </td>
      </tr>

      <tr>
        <th class="teache"> Forma de PCB </th>
        <td class="tede"> ATX </td>
      </tr>

      <tr>
        <th class="teache"> PSU Recomendada </th>
        <td class="tede"> 300W </td>
      </tr>

      <tr>
        <th class="teache"> Producción </th>
        <td class="tede"> DVI-D * 1
        HDMI-2.0b * 1 (Resolución máxima: 4096x2160 a 60 Hz) </td>
      </tr>
      ...
      <tr>
        ...
        <td class="tede"> 4.5 </td>
      </tr>

      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> Con un simple clic en la utilidad AORUS Graphics Engine, los jugadores pueden sintonizar fácilmente la tarjeta para cumplir con sus diversos requisitos de juego sin ningún conocimiento de overclocking. </td>
      </tr>
