...
<head>
  ...
  <title>Unlimited Tecnhology - producto 11</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
  <h1> Convertible 2en1 HP 14-dh0017la Intel Pentium </h1>
...
<div class="info_producto">
    ...
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 2.449.000 </p>
      <p class="precio_especial"> Hoy $ 1.779.000 </p> 
  ...
  <div class="detalles_producto">
    <p>      
  Procesador: Intel Pentium Gold 5405U 2,3 Ghz.<br>
...
<!-------------------------------- Especificaciones del producto ----------------------------->
    ...
    <div class="tab-content">
      ...
      <tr>
        ...
        <tr >
        <th class="teache"> TIPO </th>
        <td class="tede"> Convertible 2 en 1 </td>
      </tr>

      <tr>
        <th class="teache"> Referencia </th>
        <td class="tede"> 14-dh0017la </td>
      </tr>

      <tr>
        <th class="teache"> Procesador </th>
        <td class="tede"> Intel Pentium Gold 5405U 2,3 Ghz </td>
      </tr>

      <tr>
        <th class="teache"> Sistema Operativo </th>
        <td class="tede"> Windows </td>
      </tr>

      <tr>
        <th class="teache"> Capacidad del disco (SOLIDO) </th>
        <td class="tede"> 128GB </td>
      </tr>

      <tr>
        <th class="teache"> Memoria RAM </th>
        <td class="tede"> 4GB </td>
      </tr>

      <tr>
        <th class="teache"> Pulgadas </th>
        <td class="tede"> 14 Pulgadas </td>
      </tr>

      <tr>
        <th class="teache"> Resolucion De Pantalla </th>
        <td class="tede"> HD </td>
      </tr>

      <tr>
        <th class="teache"> Funcionalidades </th>
        <td class="tede"> Camara WEB Integrada, Pantalla Táctil, Windows Ink </td>
      </tr>

      <tr>
        <th class="teache"> Conectividad </th>
        <td class="tede"> Bluetooth, HDMI, USB, USB-C </td>
      </tr>
      
      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> Trabaja, escribe, juega. Hacer muchas tareas a la vez es fácil y rápido con esta poderosa PC, cuenta con una batería de larga duración para que la lleves siempre contigo. Disfruta de su diseño compacto con pantalla de borde delgado e innovadoras bisagras resistentes y confiables que permiten una rotación de 360° para que puedas utilizar el dispositivo en cuatro modos diferentes. Inspira al mundo con una laptop convertible que se adapta a ti, siéntete libre de crear, conectarte y compartir en más formas con la nueva Pavilion x360. </td>
      </tr>
