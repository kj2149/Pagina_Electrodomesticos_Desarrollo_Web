...
<head>
  ...
  <title>Unlimited Tecnhology - producto 111</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
    <h1> Fuente De Poder Cougar Vtc 600 80 </h1>
      
     <div class="producto">
        <img src="../imagenes/imagen111.png">
     </div>
<!-------------------------------- caja de informacion del producto ----------------------------->
<div class="info_producto">
          
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 300.000 </p>
      <p class="precio_especial"> $ 280.000 </p> 
      <a class="tarjeta" href=""><i class="far fa-credit-card"></i> Paga con tarjeta $ 250.000</a>
  ...
  <div class="detalles_producto">
    <p>      
  Con el exclusivo ventilador silencioso de 120 mm de COUGAR, el marco avanzado aumenta la concentración del flujo de aire y la curvatura del ventilador se ha ajustado para reducir la vibración en cualquier carga, lo que le ayuda a disfrutar de una experiencia de juego más silenciosa. </p>
  </div>
 ...
 <!-------------------------------- Especificaciones del producto ----------------------------->
    <div class="tab-content">
      ...
      <tr>
        ...
        <td class="tede"> Cougar </td>
      </tr>
      
      <tr >
        <th class="teache"> Línea </th>
        <td class="tede"> VTC </td>
      </tr>

      <tr>
        <th class="teache"> Modelo </th>
        <td class="tede"> VTC600 </td>
      </tr>

      <tr>
        <th class="teache"> Potencia De Salida </th>
        <td class="tede"> 600 W </td>
      </tr>

       <tr>
        <th class="teache"> Voltaje </th>
        <td class="tede"> 100V / 240V </td>
      </tr>

      <tr>
        <th class="teache"> Tipo De Fuente De Alimentación Para PC </th>
        <td class="tede"> ATX </td>
      </tr>

      <tr>
        <th class="teache"> Cantidad De Conectores HDD </th>
        <td class="tede"> 6 </td>
      </tr>

      <tr>
        <th class="teache"> Cantidad De Conectores PCI-E </th>
        <td class="tede"> 2 </td>
      </tr>

      <tr>
        <th class="teache"> Frecuencia </th>
        <td class="tede"> 60 Hz </td>
      </tr>

      <tr>
        <th class="teache"> Tipo De Refrigeración </th>
        <td class="tede"> AIR </td>
      </tr>

      <tr>
        <th class="teache"> Corrección Del Factor De Potencia </th>
        <td class="tede"> Activo </td>
      </tr>

      <tr>
        <th class="teache"> Con Iluminación RGB </th>
        <td class="tede"> NO </td>
      </tr>
      ...
      <tr>
        ...
        <td class="tede"> OCP (Overcurrent Protection)
        Si la corriente en una línea es más alta de lo establecido, la fuente se apagará automáticamente.
        UVP (Under Voltage Protection)
        Si el voltaje baja por debajo del valor tolerado en una línea, la fuente se apagará automáticamente.
        OVP (Over Voltage Protection)
        Si los voltajes suben por encima de los valores tolerados en una línea, la PSU se apagará automáticamente.
        SCP (Short-Circuit Protection)
        En caso de cortocircuito, esta característica evita daños a los componentes principales de la fuente de alimentación y de tu sistema.
        OPP (Over Power Protection)
        Si el sistema está sobredimensionado y requiere de la fuente más energía de la que ésta puede proporcionar, esta protección será activada..</td>
      </tr>
