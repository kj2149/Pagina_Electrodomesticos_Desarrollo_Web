...
<head>
  ...
  <title>Unlimited Tecnhology - producto 92</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
  <!--------------------------------Presenatcion del producto ----------------------------->
 <div class="especificartermino1">
     <h1> Caja Gabinete Iceberg Crystal G9 Atx - 4 Ventiladores Rgb </h1>
      
     <div class="producto">
        <img src="../imagenes/imagen92.png">
     </div>
<!-------------------------------- caja de informacion del producto ----------------------------->
<div class="info_producto">
          
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 400.000 </p>
      <p class="precio_especial"> Hoy $ 373.900 </p> 
      <a class="tarjeta" href=""><i class="far fa-credit-card"></i> Paga con tarjeta $ 320.000</a>
...
<!-------------------------------- Especificacciones del producto ----------------------------->
  <div class="detalles_producto">
    <p>      
  Iceberg Tech se complace en realizar el lanzamiento oficial del gabinete para PC: Crystal G9 – RGB. Este nuevo chasis de metal con panel frontal de vidrio templado está dirigido a PC Modders y PC Gamers, que adoran jugar con sus máquinas y mostrar su hardware. Con espacio para hasta 6 unidades y 7 ranuras de expansión para la instalación de tarjetas gráficas largas (tarjeta VGA de hasta 320 mm de longitud) disipador de CPU grande (hasta 160 mm de altura). </p>
  </div>
    ...
    <div class="tab-content">
      ...
      <tr>
        ...
        <td class="tede"> Iceberg </td>
      </tr>
      
      <tr >
        <th class="teache"> Linea </th>
        <td class="tede"> Crystal </td>
      </tr>

      <tr>
        <th class="teache"> Modelo </th>
        <td class="tede"> Crystal G9 ARGB </td>
      </tr>

      <tr>
        <th class="teache"> Factor De Forma De Disco Duro </th>
        <td class="tede"> 3.5 Pulgadas </td>
      </tr>

       <tr>
        <th class="teache"> Método de refrigeración </th>
        <td class="tede"> Water </td>
      </tr>

      <tr>
        <th class="teache"> Tamaño del ventilador </th>
        <td class="tede"> 120 Milímetros </td>
      </tr>

      <tr>
        <th class="teache"> Compatibilidad de la placa base </th>
        <td class="tede"> ATX </td>
      </tr>

      <tr>
        <th class="teache"> Dimensiones del artículo L x W x H </th>
        <td class="tede"> 15.75 x 7.91 x 17.13 pulgadas </td>
      </tr>


      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> Opciones considerables para realizar conexiones periféricas a través de los tres puertos USB y tomas de audio HD. El chasis está construido en acero SPCC de 0,50 mm y facilita el enrutamiento de cables y un buen flujo de aire del sistema. Listo para presumir sus componentes, refrigeración RGB y disipadores de agua o aire a través de la ventana completa lateral en el lado izquierdo y el panel frontal.</td>
      </tr>
