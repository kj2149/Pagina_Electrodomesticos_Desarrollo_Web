...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="../css/icono.css">  -->   
	...
	<title>Equipos todo en uno - Unlimited Tecnhology</title>
</head>
		...
		<article>
		    <img id="til" src="../imagenes/tit-cel.png" alt="celulares">
				<ul>
                    ...
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen85.jpg">
						<p>Todo En Uno Lenovo A540-24api Ryzen 3 3200 2tb/8gb<br>
						$2.599.000</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen86.jpg">
						<p>Todo en uno aio lenovo 3-22ada05 athlon silver<br>
						$2.599.000</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen87.jpg">
						<p>All in one Lenovo 23.8 pulgadas AMD RYZEN R5 4GB 1TB<br>
						$2,699,000</p></li> 
		   			<li class="colimag"><img id="imagen" src="../imagenes/imagen79.png">
						<p>In One LENOVO AIO 3 AMD Athlon 21,5"<br>
						$ 1.649.000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen81.png">
						<p>IdeaCentre A340 (21.5", Intel)<br>
						$2.529.900</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen80.png">
						<p>Todo en Uno HP Pavilion 24-xa011la<br>
						$3.599.000</p></li>                           
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen82.png">
						<p>Todo en Uno HP Pavilion 24-xa016la<br>
						$3.149.000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen83.png">
						<p>Todo En Uno LENOVO V130-20IGM CELERON J4005N 4GB 1TB DVD 19.5 LINUX NEGRO<br>
						$1.439.700</p></li>
				</ul>
		</article>
	</section>
