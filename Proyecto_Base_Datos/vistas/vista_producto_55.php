...
<head>
  ...
  <title>Unlimited Tecnhology - producto 55</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
     ><h1> Intel 10th Gen I5 10400 + Board B460 </h1>
      
     <div class="producto">
        <img src="../imagenes/imagen55.png">
     </div>
<!-------------------------------- caja de informacion del producto ----------------------------->
<div class="info_producto">
          
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 1.840.000 </p>
      <p class="precio_especial"> Hoy $1.760.000 </p> 
  ...
  <div class="detalles_producto">
    <p>      
  Magnifico Combo Intel de 10th Gen. <br>
  16GB de memoria ram DDR4. <br>
  Excelente balance precio/rendimiento. <br>
  Ideal para entusiastas y equipos gammer. <br>
  Versión con Gráficos Integrados.
 ...
 <!-------------------------------- Especificaciones del producto ----------------------------->
    <div class="tab-content">
      ...
      <tr>
        ...
        <td class="tede"> AORUS </td>
      </tr>

      <tr>
        <th class="teache"> Modelo </th>
        <td class="tede"> B460M Aorus Pro </td>
      </tr>

      <tr>
        <th class="teache"> Version </th>
        <td class="tede"> MICRO ATX </td>
      </tr>

       <tr>
        <th class="teache"> Capacidad Máxima Soportada De La Memoria RAM </th>
      ...
      <tr>
        <th class="teache"> Chipset </th>
        <td class="tede"> B460 </td>
      </tr>

      <tr>
        <th class="teache"> CPU </th>
        <td class="tede"> Core i5 - 10400 </td>
      </tr>

      <tr>
        <th class="teache"> Tipo De Memoria RAM </th>
        <td class="tede"> DDR4 </td>
      </tr>
      
      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> Magnifico Combo Intel de 10th Gen
* 16GB de memoria ram DDR4
* Excelente balance precio/rendimiento
* Ideal para entusiastas y equipos gammer
* Versión con Gráficos Integrados
* Excelente desempeño multimedia
