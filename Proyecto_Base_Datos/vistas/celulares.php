...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="../css/icono.css">  -->   
	...
	<title>Celulares - Unlimited Tecnhology</title>
</head> 
	...
	<header>
	 ...
	 <div class="buscar1">
			<div class=" barra-btn-buscar">
		      ...
		      <a class="registrar1" href="viistas/registro.php" > <button type="button" class="bot-log-reg">Registrarse</button></a>
        </div>
		    ...
		    <img id="til" src="../imagenes/tit-cel.png" alt="celulares">
				<ul>
					...
					<li class="colimag"><img id="imagen" src="../imagenes/imagen5.png">
						<p>Celular samsung galaxy m31 128gb rojo cover negro<br><br>
							   $990,900
							</p></li>
				    <li class="colimag"><img id="imagen" src="../imagenes/imagen6.png">	
						<p>Celular samsung galaxy a71 128gb plateado + Seguro gratis<br><br>
							   $1,699,000
							</p></li>
				    <li class="colimag"><img id="imagen" src="../imagenes/imagen7.png">	
						<p>Celular MOTO E6 Play	<br><br><br><br>
								$339.900
							</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen8.png">	
						<p>Celular ASUS ROG Phone 128GB<br><br><br>
								 $2.999.900
								</p></li>
				</ul>    
		</article>
