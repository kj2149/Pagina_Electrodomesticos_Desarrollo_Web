...
<!--/////////////          HEAD           //////////////-->
	...
	<section>
		<article>
		    <h1 class="til">COMBO TECLADO + MUOUSE</h1>
	            <P>
			         <ul>
						<li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen57.webp">
							<h3>Combo Teclado Y Mouse Cooler Master Ms111 Rgb</h3>
							<h4>$279,000</h4></li>
                            <li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen58.webp">
							<h3>COMBO TECLADO Y MOUSE GAMER 7 COLORES XTRIKE ME</h3>
							<h4>$79,900</h4></li>
                            <li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen59.webp">
							<h3>Combo Ultra Gamer Full Mouse+teclado+pad Gamer</h3>
							<h4>$98,900</h4></li>
                            <li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen60.webp">
							<h3>Combo Teclado + Mouse Gamer T21 Multicolor Soporte Celular</h3>
							<h4>$184,000</h4>
                            </li><li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen61.webp">
							<h3>Combo Mouse + Teclado Seisa</h3>
							<h4>$70,000</h4></li>
                            </li><li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen54.webp">
							<h3>Board Asus Rog Strix B450 F Gaming Amd</h3>
							<h4>$620,000</h4></li>
                            </li><li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen55.webp">
							<h3>Combo Intel 10th Gen I3 10100 + Board B460 + Memoria 16gb</h3>
							<h4>$1,450,000</h4></li>
                            </li><li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen56.webp">
							<h3>Combo Amd Ryzen 7 3700x + Board B550 + Memoria Ram 32gb</h3>
							<h4>$3,100,000</h4></li>
