...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
  <h1> Caja Gabinete Cooler Master Masterbox Td500 Mesh White </h1>
      
     <div class="producto">
        <img src="../imagenes/imagen89.png">
     </div>
...
<div class="info_producto">
    ...
    <div class="caja_precio">
      ...
      <p class="precio_especial"> Hoy $ 479.000 </p> 
  ...
  <div class="detalles_producto">
    <p>      
  MasterBox TD500 Mesh y MasterBox TD500 Mesh White encarnan el "rendimiento del flujo de aire" en una forma artística. Tres ventiladores ARGB preinstalados inundan el sistema con flujo de aire e iluminación, lo que demuestra el efecto único de ARGB a través del vidrio templado cristalino. </p>
  </div>
 ...
 <!-------------------------------- Especificacciones del producto ----------------------------->
    <div class="tab-content">
      ...
      <tr>
        <th class="teache"> Número De Modelo </th>
        <td class="tede"> MCB-D500D-KGNN-S01, MCB-D500D-KGNN-S00, MCB-D500D-WGNN-S01, MCB-D500D-WGNN-S00 </td>
      </tr>
      
      <tr >
        <th class="teache"> Serie  </th>
        <td class="tede"> Serie MasterBox </td>
      </tr>

      <tr>
        <th class="teache"> Tamaño </th>
        <td class="tede"> Media torre </td>
      </tr>

      <tr>
        <th class="teache"> Materiales </th>
        <td class="tede"> Acero, plástico, vidrio templado, malla </td>
      </tr>

       <tr>
        <th class="teache"> Dimensiones (L X AN X AL) </th>
        <td class="tede"> 493 x 217 x 469 mm (incl. Protuberancias), 429,5 x 205 x 447 mm (excluye protuberancias) </td>
      </tr>

      <tr>
        <th class="teache"> Peso </th>
        <td class="tede"> 6,95 kilogramos </td>
      </tr>

      <tr>
        <th class="teache"> Soporte De la Placa Base </th>
        <td class="tede"> Mini ITX, Micro ATX, ATX, SSI CEB, E-ATX *, (* soporte para hasta 12 "x 10.7", limitará las funciones de administración de cables </td>
      </tr>

      <tr>
        <th class="teache"> Ranuras de expansión </th>
        <td class="tede"> 7 </td>
      </tr>
      ...
      <tr>
        ...
        <td class="tede"> Cada elemento de diseño está diseñado con precisión para maximizar el rendimiento y la calidad junto con la estética, evolucionando más allá de los límites actuales de iluminación y refrigeración. Con tecnología avanzada esculpida en bellas artes, las MasterBox TD500 Mesh & Mesh White se abren camino hacia la vanguardia.</td>
      </tr>
