		...
		<ul id="css3menu1" class="topmenu">
			...
			<li class="toproot"><a href="#" target="marco"style="height:28px;line-height:22px;"><span>Productos</span></a>
				<ul>
					...
					<li><a href="../vistas/gabinetes.html" target="marco">Gabinetes</a></li>
					<li><a href="../vistas/fuentes de poder.html" target="marco">Fuentes De Poder</a></li>
					<li><a href="../vistas/impresoras.html" target="marco">Impresoras</a>
					<li><a href="../vistas/herramientas.html" target="marco">herramientas</a>
			

					<ul style="left:150px;">	
					    <li><a href="../vistas/componentes.html">Componentes</a></li>
						<li><a href="../vistas/repuestos.html">Repuestos</a></li>
						<li><a href="../vistas/cableado.html">Cableado</a></li>
                        </ul>
						</li>
				</ul>
			</li>
...
<!--LISTA DE CATEGORIAS-->
	...
	<!--Fin del div antes de aside-->
		...
		<div class="slider">
			<ul>
				<li><img src="../imagenes/s3.png" alt=""></li>
				<li><img src="../imagenes/s7.png" alt=""></li>
				<li><img src="../imagenes/s5.png" alt=""></li>
				<li><img src="../imagenes/s6.png" alt=""></li>
			</ul>
		</div>
