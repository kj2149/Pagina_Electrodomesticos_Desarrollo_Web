...
<div class="container-contactenos">
	<div class="con-tel-hor">
        <div class="contac">
       <center><h1>CONTACTENOS</h1></center>
       <p>
        Una firma reconocida por ofrecer la mejor experiencia en soluciones tecnológicas,
        ...
        para los  diferentes sectores comercial, industrial y educación. CONTACTENOS! 

       </p>
        </div>

        <div class="telefonos">
       <center><h2>TELEFONOS</h2></center>
       <p> <center> En Bogota: 316 514 0646<br>
         El resto de pais: 301 366 7023 </center> 
        </p>
        </div>

        <div class="horario">
       <center><h2>HORARIOS DE ATENCIÓN</h2></center>
       <p><center>Lunes a Viernes : 8:00 am / 5:00 pm<br> 
           Sabados: 8:00 am / 2:00 pm </center> 
       </p>
     </div>
    </div>
    ...
    <div class="informacion">
      ...
      <center><h2>PUNTOS DE ATENCION</h2></center> 
        <p>Calle 167 C No. 54C-36 Piso 3 - Bogotá D. C. - Colombia
		 <center><img src="../imagenes/ubicacion.JPG" alt="ubicacion" width="290" height="250" /></center><br>
		 <center><h2>CORREO ELECTRONICO</h2></center>
		 <center> editoz@hotmail.com - editozz@gmail.com </center>
		 <center>
			<br>
		 <img src="../imagenes/2.png" alt="ubicacion" width="100" height="100" />	
		 </center>	
        </p>
     </p>
    </div>
