...
<div class="especificartermino">
    ...
    <p>
        ...
        (ii) celebras un contrato legalmente inculante para comprar un artículo cuando te comprometed a comprar un artículo y 
        ...
        Nos reservamos el derecho de cambiar nuestros precios para los productos que se muestran en cualquier momento y de corregir los 
        errores de precios que pueden ocurrir inadvertidamente. 
        Información adicional sobre precios e impuestos sobre las ventas está disponible en la página de pagos.  <br> <br>    
...
<div class="especificartermino">
    ...
    <p>
        Para cualquier producto no dañado, simplemente devuélvelo con los accesorios y el paquete incluidos junto con el recibo original (o recibo de regalo) dentro de 
        los 14 días posteriores a la fecha que recibiste el producto, y lo cambiaremos o te ofreceremos un reembolso basado en el método de pago original.
        Además, ten en cuenta lo siguiente: <br> <br>
        (i) Los productos solo se pueden devolver en el país en el que se compraron 
        originalmente; y (ii) <br> <br>
        los siguientes productos no son elegibles para la devolución: <br> <br>
        [lista de artículos].
    </p>
</div>
...
<div class="especificartermino">
    ...
    <p>
        ...
        total cuando nos devuelva el producto.
        Pagaremos el envío de los productos reparados o 
