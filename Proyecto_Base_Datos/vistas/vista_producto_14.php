...
<head>
  ...
  <title>Unlimited Tecnhology - producto 14</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
     <h1> HP 24-dd0000la Intel Pentium </h1>
...
<div class="info_producto">
  ...
  <div class="detalles_producto">
    <p>      
  Velocidad del procesador: 2 GHz. <br>
  Con Bluetooth: Sí. <br>
...
<!-------------------------------- Especificaciones del producto ----------------------------->
    ...
    <div class="tab-content">
      ...
      <tr>
        ...
        <td class="tede"> All in One </td>
      </tr>

      <tr>
        <th class="teache"> Referencia </th>
        <td class="tede"> 24-dd0000la </td>
      </tr>

      <tr>
        <th class="teache"> Procesador </th>
        <td class="tede"> Intel Pentium J5040 2.0Ghz </td>
      </tr>
      ...
      <tr>
        <th class="teache"> Capacidad Del Disco Duro Del Computador </th>
        <td class="tede"> 1TB </td>
      </tr>
      ...
      <tr>
        ...
        <td class="tede"> 24 Pulgadas </td>
      </tr>

      <tr>
        <th class="teache"> Resolucion De Pantalla </th>
        <td class="tede"> FULL HD </td>
      </tr>
      
      
      <tr>
        <th class="teache"> Conectividad </th>
        <td class="tede"> Bluetooth, USB, WIFI </td>
      </tr>
