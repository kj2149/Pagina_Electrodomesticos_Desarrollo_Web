...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="../css/icono.css">  -->   
	...
	<title>Componentes - Unlimited Tecnhology</title>
</head>
...
<!--/////////////      contenido      //////////////-->
	...
	<section class="container-contenido">
		<article>
			<img id="til" src="../imagenes/tit-com.png" alt="componentes">
				<ul>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen29.jpg">	
						<p>Calado de rodamientos interiores lavadoras<br>
						$749,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen30.jpg">	
						<p>Máquina para cierre membrana de válvula<br>
						$749,0000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen31.jpg">	
						<p>Control de estanqueidad de válvulas y trazabilidad<br>
						$600,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen32.jpg">	
						<p>Máquina para test de bisagras de lavavajillas<br>
						$1,600,000</p></li>			
                </ul>             
		</article>
	</section>
