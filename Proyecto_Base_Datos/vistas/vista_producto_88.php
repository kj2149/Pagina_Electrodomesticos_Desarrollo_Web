...
<head>
  ...
  <title>Unlimited Tecnhology producto 88</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
     <h1> Caja Gabinete Iceberg Flux Blanca Rgb Vidrio Templado </h1>
      
     <div class="producto">
        <img src="../imagenes/imagen88.png">
     </div>
...
<div class="info_producto">
    ...
    <div class="caja_precio">
      ...
      <p class="precio_especial"> Hoy $ 259.900 </p> 
  ...
  <div class="detalles_producto">
    <p>      
  Caja de PC Gamer Con Vidrio Templado y Tira RGB Frontal Iceberg FLUX Blanca con ventilador de 120mm. Excelente refrigeración y Fuente de poder en la parte inferior del case gamer. Filtro Antipolvi magnetico y espacio para Gestión de Cable. </p>
  </div>
...
<!-------------------------------- Especificaciones del producto ----------------------------->
    ...
    <div class="tab-content">
      ...
      <tr >
        ...
        <td class="tede"> Flux </td>
      </tr>

      <tr>
        <th class="teache"> Modelo </th>
        <td class="tede"> Flux RGB Blanca </td>
      </tr>

      <tr>
        <th class="teache"> Slots De Expansión </th>
        <td class="tede"> 7 Slots </td>
      </tr>

       <tr>
        <th class="teache"> Puertos </th>
        <td class="tede"> 1 x USB 3.0, 1 x USB 2.0, HD Audio </td>
      </tr>

      <tr>
        <th class="teache"> Ventilador (es) </th>
        <td class="tede"> 1 x 120mm Negro </td>
      </tr>

      <tr>
        <th class="teache"> Tamaño </th>
        <td class="tede"> Altura 435mm, Ancho 180mm, profundidad 380mm </td>
      </tr>

      <tr>
        <th class="teache"> Refrigeración </th>
        <td class="tede"> Incluye ventilador trasero de 120mm </td>
      </tr>


      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede">  Excelente refrigeración y Fuente de poder en la parte inferior del case gamer. Filtro Antipolvi magnetico y espacio para Gestión de Cable.</td>
      </tr>
       
      <tr>
       <th class="teache"> Garantía de Fabricante (Meses) </th>
       <td class="tede"> 6 Meses </td>
      </tr>
