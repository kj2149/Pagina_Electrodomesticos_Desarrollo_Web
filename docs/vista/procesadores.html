...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="../css/icono.css">  -->   
	...
	<title>Procesadores - Unlimited Tecnhology</title>
</head>
		    ...
		    <img id="til" src="../imagenes/tit-proc.png" alt="procesadores">
				...
				<ul>
                    ...
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen106.png">
						...
						$649.999</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen106.png">	
						<p>Procesador Amd Ryzen 7 3800x 4.5ghz 8 Nucleos Nuevo @att<br>
						$1.599.000</p></li>       
					<li class="colimag"><img id="imagen" src="../imagenes/imagen110.png">	
						<p>Procesador Intel Core I5 10600k<br>
						$1,299,000</p></li>
                    <li class="colimag"><img id="imagen" src="../imagenes/imagen105.png">	
						<p>Procesador Amd Ryzen 7 3700x 8 Nucleos Hasta 4.4ghz @att<br>
						$1.395.000</p></li> 
		        </ul>
		</article>
	</section>
