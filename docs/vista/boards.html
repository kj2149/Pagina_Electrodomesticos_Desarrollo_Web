     ...
     <!--LISTA DE CATEGORIAS-->
       ...
       <div class="lista-cate"></div>
		...
		<ul id="css3menu1" class="topmenu">
			...
			<li class="toproot"><a href="quienes_somos.html" target="marco" style="height:28px;line-height:22px;"><span>Quienes somos?</span></a>
		    ...
		    <img class="til" src="../imagenes/tit-cel.png" alt="celulares">
	            ...
	            <P>
					<ul>
                            ...
                            <li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen50.webp">
							<h3>Board Gigabyte A320m</h3>
							<h4>$280,000</h4></li>
                            <li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen51.webp">
							<h3>Board Gigabyte B450m Ds3h Amd 3 Gen Y 2 Gen</h3>
							<h4>$325,000</h4></li>
							<li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen53.webp">
							<h3>Board Asus Rog Strix B450 F Gaming Amd</h3>
							<h4>$640,000</h4></li>
							<li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen54.webp">
							<h3>Board Asus Rog Strix B450 F Gaming Amd</h3>
							<h4>$620,000</h4></li>
							
                            <li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen55.webp">
							<h3>Combo Intel 10th Gen I3 10100 + Board B460 + Memoria 16gb</h3>
							<h4>$1,450,000</h4></li>
							<li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen52.webp">
							<h3>Tarjeta Madre G41 Socket 775 Ddr3 4usb Vga Nueva Garantia</h3>
							<h4>$184,000</h4>
							...
							<h4>$3,100,000</h4></li>
							<li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen49.webp">
							<h3>Board Gigabyte A520M DS3H</h3>
							<h4>$339,500</h4></li>
