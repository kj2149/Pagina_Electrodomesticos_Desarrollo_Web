...
<head>
  ...
  <title>Unlimited Tecnhology - producto 108</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
     <h1> Procesador Intel Core I5 10400 2.9ghz </h1>
	 
     <div class="producto">
        <img src="../imagenes/imagen108.png">
     </div>
<!-------------------------------- caja de informacion del producto ----------------------------->
<div class="info_producto">
          
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 800.000 </p>
      <p class="precio_especial"> Hoy $ 726.000 </p> 
  ...
  <div class="detalles_producto">
    <p>      
  Productividad y entretenimiento, todo disponible en tu computador de escritorio. La superioridad tecnológica de INTEL es un beneficio para todo tipo de profesionales. Asegura el mejor rendimiento de las aplicaciones, de la transferencia de datos y la conexión con otros elementos tecnológicos.
 ...
 <!-------------------------------- Especificaciones del producto ----------------------------->
    <div class="tab-content">
      ...
      <tr >
        ...
        <td class="tede"> Intel </td>
      </tr>

      <tr>
        <th class="teache"> Modelo </th>
        <td class="tede"> BX80684G4930 </td>
      </tr>

      <tr>
        <th class="teache"> Línea </th>
        <td class="tede"> Core i5 </td>
      </tr>

       <tr>
        <th class="teache"> Generación </th>
        <td class="tede"> Décima Generación </td>
      </tr>

      <tr>
        <th class="teache"> Velocidad </th>
        <td class="tede"> 2.9 GHz (hasta 4.3 GHz) </td>
      </tr>

      <tr>
        <th class="teache"> Cache </th>
        <td class="tede"> 12 MB </td>
      </tr>

      <tr>
        <th class="teache"> Socket </th>
        <td class="tede"> Socket 1200 </td>
      </tr>

      <tr>
        <th class="teache"> Microarquitectura </th>
        <td class="tede"> Comet Lake-S </td>
      </tr>

      <tr>
        <th class="teache"> Núcleos </th>
        <td class="tede"> 6 Núcleosv </td>
      </tr>

      <tr>
        <th class="teache"> Gráficos Integrados </th>
        <td class="tede"> Intel HD Graphics 630 </td>
      </tr>

      <tr>
        <th class="teache"> Frecuencia De Gráficos </th>
        <td class="tede"> hasta 1.10 GHz </td>
      </tr>

      <tr>
        <th class="teache"> Disipador </th>
        <td class="tede"> Incluido </td>
      </tr>

      <tr>
        <th class="teache"> Tecnología de Fabricación </th>
        <td class="tede"> 14 nm </td>
      </tr>

      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> Núcleos: el corazón del procesador
        En este producto, encontrarás los núcleos, que son los encargados de ejecutar las instrucciones y actividades que le asignas a tu dispositivo. Estos tienen relación directa con dos elementos: los hilos y el modelo. Por lo tanto, a la hora de elegir un procesador, es importante que valores los tres en su conjunto.</td>
      </tr>
