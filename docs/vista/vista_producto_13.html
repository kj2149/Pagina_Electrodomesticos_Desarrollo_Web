...
<head>
  ...
  <title>Unlimited Tecnhology - producto 13</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
     <h1> portatil hp 14-cf1045la Intel Pentium </h1>
...
<div class="info_producto">
    ...
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 1.779.000 </p>
      <p class="precio_especial"> Hoy $ 1.499.000 </p> 
 ...
 <!-------------------------------- Especificaciones del producto ----------------------------->
    <div class="tab-content">
      ...
      <tr>
        ...
        <td class="tede"> Portátil </td>
      </tr>

      <tr>
        <th class="teache"> Referencia </th>
        <td class="tede"> 14-cf1045la </td>
      </tr>

      <tr>
        <th class="teache"> Procesador </th>
        <td class="tede"> Intel Pentium Gold 5405U 2,3 Gz </td>
      </tr>
      ...
      <tr>
        <th class="teache"> Capacidad Del Disco (Solido) Del Computador </th>
      ...
      <tr>
        ...
        <td class="tede"> Camara WEB Integrada </td>
      </tr>
      
      <tr>
        <th class="teache"> Conectividad </th>
        <td class="tede"> Bluetooth, HDMI, USB, USB-C, WIFI </td>
      </tr>
      
      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> La tecnología de múltiples núcleos está diseñada para mejorar el rendimiento de ciertos productos de software. No todos los clientes ni todas las aplicaciones de software se beneficiarán con el uso de esta tecnología. El rendimiento y la velocidad varían según la carga de trabajo de las aplicaciones y las configuraciones del hardware y software. Los nombres, las marcas y/o la numeración de Intel no son una medición de mayor rendimiento. </td>
      </tr>
