...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="../css/icono.css">  -->   
	...
	<title>Tarjetas Graficas - Unlimited Tecnhology</title>
</head>
		    ...
		    <img id="til" src="../imagenes/tit-Tarj.png" alt="tarjetas graficas">
				<ul>
					...
					<li class="colimag"><img id="imagen" src="../imagenes/imagen97.png">	
						...
						$940.000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen101.png">	
						<p>Tarjeta Grafica Sapphire Pulse Rx 550 4gb Ddr5<br>
						$899,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen102.png">	
						<p>Msi Computer Video Tarjetas Graficas Geforce Gtx 1050 Ti Gam<br>
						$1,699,900</p>	</li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen103.png">	
						<p>Tarjeta De Video Nvidia Quadro M2000 4gb Gddr5 Display Port<br>
						$1,249,000</p></li>
		        </ul>
		</article>
	</section>
