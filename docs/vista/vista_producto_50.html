...
<head>
  ...
  <title>Unlimited Tecnhology producto 50</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
     <h1> Board Gigabyte A320m </h1>
      
     <div class="producto">
        <img src="../imagenes/imagen50.png">
     </div>
<!-------------------------------- caja de informacion del producto ----------------------------->
<div class="info_producto">
          
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 280.000 </p>
      <p class="precio_especial"> Hoy $ 199.000 </p> 
  ...
  <div class="detalles_producto">
    <p>      
  Compatible con procesadores AMD Ryzen y 7ª generación serie A/Athlon. <br>
  Doble canal sin ECC sin búfer DDR4, 2 DIMMs. <br>
  PCIe Gen3 x4 M.2 ultrarrápido con soporte PCIe NVMe y SATA. <br>
  Condensadores de audio de alta calidad y protección de ruido de audio. <br>
  Realtek Gigabit LAN con software de acelerador de Internet cFosSpeed
...
<!--------------------------------Especificaciones del producto ----------------------------->
    ...
    <div class="tab-content">
      ...
      <tr>
        ...
        <td class="tede"> Gigabyte </td>
      </tr>

        <tr >
        <th class="teache"> Zócalo de CPU </th>
        <td class="tede"> Socket AM4 </td>
      </tr>

      <tr>
        <th class="teache"> Tecnología De Memoria RAM </th>
        <td class="tede"> DDR4 </td>
      </tr>

      <tr>
        <th class="teache"> Procesadores Compatibles </th>
        <td class="tede"> AMD A-Series, AMD Athlon </td>
      </tr>

      <tr>
        <th class="teache"> Velocidad De Memoria </th>
        <td class="tede"> 3200 MHz </td>
      </tr>

      <tr>
        <th class="teache"> Plataforma </th>
        <td class="tede">   Windows 8.1, Windows 8 Pro, Windows 8, Windows 10 </td>
      </tr>

      <tr>
        <th class="teache"> Series </th>
        <td class="tede"> GA-A320M-S2H </td>
      </tr>

      <tr>
        <th class="teache"> Capacidad De Almacenamiento De Memoria </th>
        <td class="tede"> 1 TB </td>
      </tr>

      <tr>
        <th class="teache"> Interfaz De Tarjeta De Gráficos </th>
        <td class="tede"> PCI-E </td>
      </tr>

      <tr>
        <th class="teache"> Ranuras De Memoria Disponibles </th>
        <td class="tede"> 2 </td>
      </tr>
      
      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> Supports AMD Ryzen and 7th Generation A Series/Athlon Processors Dual Channel Non ECC Unbuffered DDR4, 2 DIMMs Ultra-Fast PCIe Gen3 x4 M.2 with PCIe NVMe and SATA mode support High Quality Audio Capacitors and Audio Noise Guard Realtek Gigabit LAN with cFosSpeed Internet Accelerator Software Smart Fan 5 features 5 Temperature Sensors and 2 Hybrid Fan Headers Gigabyte UEFI BIOS All New Gigabyte APP Center, Simple and Easy Use. Micro ATX Form Factor; 24.4 cm x 19.5 cm. </td>
      </tr>
