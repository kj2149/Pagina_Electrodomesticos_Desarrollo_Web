...
<head>
  ...
  <title>Unlimited Tecnhology - producto 12 </title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
     <h1> portatil hp intel core i3 </h1>
...
<div class="info_producto">
    ...
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 1.649.000 </p>
      <p class="precio_especial"> Hoy $ 1.359.000 </p> 
  ...
  <div class="detalles_producto">
    <p>      
  Procesador: Intel Core I3 7020U.<br>
 ...
 <!-------------------------------- Especificaciones del producto ----------------------------->
    <div class="tab-content">
      ...
      <tr>
        ...
        <td class="tede"> 14-ck0010la </td>
      </tr>

      <tr>
        <th class="teache"> Procesador </th>
        <td class="tede"> Intel Core I3 7020U </td>
      </tr>

      <tr>
        <th class="teache"> Generación Procesador Intel </th>
        <td class="tede"> Intel 7ta Generación </td>
      </tr>
      ...
      <tr>
        <th class="teache"> Unidad Óptica </th>
        <td class="tede"> No tiene </td>
      </tr>
      
      <tr>
        <th class="teache"> Conectividad </th>
        <td class="tede"> Bluetooth, HDMI, USB, WIFI </td>
      </tr>
      
      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> Creada con un diseño delgado y moderno para mantenerte conectado y con todas las tareas bajo control, con rendimiento confiable y batería duradera. </td>
      </tr>
