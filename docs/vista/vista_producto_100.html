...
<head>
  ...
  <title>Unlimited Tecnhology - producto 100 -</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
     <h1> Tarjeta Video Msi Gt 710 2gb Ddr3 Low Profile Pci-e 2.0 </h1>
      
     <div class="producto">
        <img src="../imagenes/imagen100.png">
     </div>
<!-------------------------------- caja de la informacion del producto ----------------------------->
<div class="info_producto">
          
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 310.000 </p>
      <p class="precio_especial"> Hoy $ 280.000 </p> 
  ...
  Tipo de memoria gráfica: GDDR3. <br>
  Interfaz con la placa madre: PCI-Express 2.0. <br>
  Tamaño de memoria: 2 GB. <br>
  Contectividad: VGA,DL-DVI-D,HDMI.
...
<!-------------------------------- Especificaciones del producto ----------------------------->
    ...
    <div class="tab-content">
      ...
      <tr>
        <th class="teache"> Fabricante </th>
        <td class="tede"> Nvidia </td>
      </tr>

        <tr >
        <th class="teache"> Marca </th>
        <td class="tede"> MSI </td>
      </tr>

      <tr>
        <th class="teache"> Línea </th>
        <td class="tede"> GT710 2GD3 LP </td>
      </tr>

      <tr>
        <th class="teache"> Serie </th>
        <td class="tede"> GeForce 700 Series </td>
      </tr>

       <tr>
        <th class="teache"> Modelo </th>
        <td class="tede"> GT 710 </td>
      </tr>

      <tr>
        <th class="teache"> Versión </th>
        <td class="tede"> GT 710 2GD3 LP </td>
      </tr>

      <tr>
        <th class="teache"> Tamaño De La Memoria </th>
        <td class="tede"> 2 GB </td>
      </tr>

      <tr>
        <th class="teache"> Tipo De Memoria Gráfica </th>
        <td class="tede"> GDDR3 </td>
      </tr>

      <tr>
        <th class="teache"> Interfaz Con La Placa Madre </th>
        <td class="tede"> PCI-Express 2.0 </td>
      </tr>

      <tr>
        <th class="teache"> Bus de memoria  </th>
        <td class="tede"> 64 bit </td>
      </tr>

      <tr>
        <th class="teache"> Velocidad de la memoria </th>
        <td class="tede"> 1600 MHz </td>
      </tr>

      <tr>
        <th class="teache"> Cantidad De Núcleos </th>
        <td class="tede"> 192 </td>
      </tr>

      <tr>
        <th class="teache"> Frecuencia Base Del Núcleo </th>
        <td class="tede"> 954 MHz </td>
      </tr>
      ...
      <tr>
        <th class="teache"> Conectividad </th>
        <td class="tede"> VGA,DL-DVI-D,HDMI </td>
      </tr>

      <tr>
        <th class="teache"> Resolución Máxima </th>
        <td class="tede"> 4096x2160 </td>
      </tr>

      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> Es una tarjeta con una relación calidad - precio muy buena. el adaptador de perfil bajo incluido es muy fácil de cambiar. el software que lleva en el disco es muy completo para sacar el mayor rendimiento de la gráfica. Interfaz PCI Express x2.0, Tamaño de la memoria (MB) 2048 (2GB) DDR3 1600 MHz, Interfaz de memoria 64-bit. Puertos: Dual-link DVI-D, HDMI (versión 1.4a) y D-Sub. </td>
      </tr>
