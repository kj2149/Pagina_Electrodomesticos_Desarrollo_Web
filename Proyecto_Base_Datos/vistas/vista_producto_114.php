...
<head>
  ...
  <title>Unlimited Tecnhology - producto 114</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
  <h1> Thermaltake Toughpower Irgb Plus 1200w Platinum </h1>
      
     <div class="producto">
        <img src="../imagenes/imagen114.png">
     </div>
<!--------------------------------caja de informacion del producto ----------------------------->
<div class="info_producto">
          
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 2.310.000 </p>
      <p class="precio_especial"> Hoy $ 2.049.000 </p> 
      <a class="tarjeta" href=""><i class="far fa-credit-card"></i> Paga con tarjeta $ 2.000.000</a>
  ...
  <div class="detalles_producto">
    <p>      
     Las especificaciones del producto descritas en el anuncio son tomadas de las páginas del fabricante o de Internet, es posible que pueda haber errores en dicha información (si es así por favor infórmenos), por eso es de total responsabilidad del Cliente tener el conocimiento técnico del producto, nosotros no somos responsables de una especificación errónea. Garantizamos que entregamos el producto descrito con la referencia descrita. </p>
  </div>
...
<!-------------------------------- Especificaciones del producto ----------------------------->
    ...
    <div class="tab-content">
      ...
      <tr>
        ...
        <td class="tede"> Thermaltake Technology </td>
      </tr>
      
      <tr >
        <th class="teache"> Línea </th>
        <td class="tede"> Toughpower Series </td>
      </tr>

      <tr>
        <th class="teache"> Modelo </th>
        <td class="tede"> TP-1200AH5CEG </td>
      </tr>

      <tr>
        <th class="teache"> Potencia De Salida </th>
        <td class="tede"> 1200 W </td>
      </tr>

       <tr>
        <th class="teache"> Voltaje </th>
        <td class="tede"> 115V / 240V </td>
      </tr>

      <tr>
        <th class="teache"> Con Protección De Bajo Voltaje </th>
        <td class="tede"> NO </td>
      </tr>

      <tr>
        <th class="teache"> Cantidad De Conectores SATA </th>
        <td class="tede"> 12 </td>
      </tr>
      ...
      <tr>
        <th class="teache"> Certificación De Eficiencia </th>
        <td class="tede"> 80 Plus Gold </td>
      </tr>


      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> *** Smart Power Management (SPM) es un software basado en la nube que integra perfectamente tres plataformas inteligentes: DPS G PC APP 3.0, DPS G Smart Power Management Cloud 1.0 y DPS G Mobile APP 1.0, y compila estadísticas clave sobre su PC en gráficos detallados y averías para la vista y administración del estado de tu PC instantánea. Con fácil acceso a SPM a través de su PC o dispositivos móviles.</td>
      </tr>
