...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="../css/icono.css">  -->   
	...
	<title>Computadores - Unlimited Tecnhology</title>
</head>
		    ...
		    <img id="til" src="../imagenes/tit-compu.png" alt="computadores">
				<ul>
					...
					<li class="colimag"><img id="imagen" src="../imagenes/imagen16.png">	
						...
						$1,200,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen17.png">	
					    <p>Portátil LENOVO 14" Pulgadas S145 Intel Core i3 Ram 4GB <br><br>
						$1,400,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen18.png">	
						<p>Computador HUAWEI Matebook X Pro 13.9 " Pulgadas 1TB SSD<br><br>
						$1,250,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen19.png">	
						<p>Portátil ASUS VivoBook X413EA-EB249T<br><br><br>
						$3.499.000</p></li>
		        </ul>
	    </article>
	</section>
