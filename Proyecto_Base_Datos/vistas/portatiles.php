...
<!--/////////////          HEAD           //////////////-->
	...
	<section>
		<article>
		    <h1 class="til">PORTATILES</h1>
	            <P>
			         <ul>
						<li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen62.webp">
							<h3>Portatil Asus X409ma-bv155t Celeron/4gb/500gb/w10</h3>
							<h4>$1.449.900</h4></li>
                            <li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen63.png">
							<h3>Portatil Asus X409ja-ek019t Core I3/256gb Ssd/4gb/w10</h3>
							<h4>$1.699.900</h4></li>
                            <li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen64.png">
							<h3>Portátil ASUS VivoBook M433IA-EB117T AMD Ryzen 5 14" Pulgadas</h3>
							<h4>$ 2.799.000</h4></li>
                            <li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen65.png">
							<h3>Portatil Asus X409MA-BV176 Intel Celeron N4020 1 Tb 4gb Endless</h3>
							<h4>$1.399.000</h4>
                            </li><li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen66.png">
							<h3>Portátil Gamer ACER AN515-54-53GZ Intel Core i5 15.6 Pulgadas 8GB RAM Disco Duro 1TB Negro</h3>
							<h4>$ 3.339.000</h4></li>
                            </li><li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen67.webp">
							<h3>Computador Portátil Gamer ROG Zephyrus Duo 15 - 15,6" Pulgadas GX550LXS-HC106T Procesador Intel Core i9 </h3>
							<h4>$19,599,000</h4></li>
