...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="../css/icono.css">  -->   
	...
	<title>Herramientas - Unlimited Tecnhology</title>
</head>
...
<!--/////////////         contenido          //////////////-->
		...
		<article>
		    <img id="til" src="../imagenes/tit-herr.png" alt="herramientas">
				<ul>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen21.png">	
						<p>Combo Peluquera Wahl Deluxe Groom Pro 3 En 1<br>
						$320,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen22.png">	
						<p>Taladro + Atornillador + Brocas + 40pcs<br>
						$190,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen23.png">	
						<p>Taladro Atornillador 20v 1/2 Total Tools<br>
						$699,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen24.png">	
						<p>Combo Taladro 850w Makita Y Pulidora 850w<br>
						$199,900</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen25.png">	
						<p>Set De 179 Herramientas Con Estuche Klatter<br>
						$99,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen26.png">	
						<p>Herramientas Taladro Caladora Lijadora Y Linterna<br>
						$629,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen27.png">	
						<p>Set Herramienta Manual 16p K-shm16<br>
						$749,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen28+.png">	
						<p>Portátil Lenovo S145 Intel Core i3 14" Pulgadas<br>
						$1,600,000</p></li>		
                </ul>            		   
		</article>
	</section>
