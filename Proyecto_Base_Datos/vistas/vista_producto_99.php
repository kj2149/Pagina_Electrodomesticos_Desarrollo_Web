...
<head>
  ...
  <title>Unlimited Tecnhology - producto 99</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
     <h1> Tarjeta Grafica Asrock Phantom Rx 550 2gb Ddr5 </h1>
      
     <div class="producto">
        <img src="../imagenes/imagen99.png">
     </div>
<!-------------------------------- caja de informacion del producto ----------------------------->
<div class="info_producto">
          
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 940.000 </p>
      <p class="precio_especial"> Hoy $ 899.000 </p> 
  ...
  <div class="detalles_producto">
    <p>      
  Prepárate para experimentar juegos HDR brillantes y suaves. Disfruta de un vibrante contenido HDR mientras eliminas las lágrimas y el picado de la imagen para un juego suave y sin esfuerzo. Compensación de baja velocidad de fotogramas, baja latencia, Plug and Play y HDR Ready. Eso es Radeon FreeSync™ 2 HDR.
 ...
 <!-------------------------------- especificaciones del producto ----------------------------->
    <div class="tab-content">
      ...
      <tr>
        <th class="teache"> Modelo GPU </th>
        <td class="tede"> Polaris </td>
      </tr>

        <tr >
        <th class="teache"> Variante </th>
        <td class="tede"> Polaris 11 </td>
      </tr>

      <tr>
        <th class="teache"> Tamaño Del Chip </th>
        <td class="tede"> 438 mm2 </td>
      </tr>

      <tr>
        <th class="teache"> N.º De Transistores </th>
        <td class="tede"> 2200 Millones </td>
      </tr>

       <tr>
        <th class="teache"> TFabricación </th>
        <td class="tede"> 14 nm </td>
      </tr>

      <tr>
        <th class="teache"> Bloques </th>
        <td class="tede"> 10 </td>
      </tr>

      <tr>
        <th class="teache"> Sombreadores </th>
        <td class="tede"> 512 </td>
      </tr>

      <tr>
        <th class="teache"> Uds. Textura </th>
        <td class="tede"> 32 </td>
      </tr>

      <tr>
        <th class="teache"> Uds. Renderizado </th>
        <td class="tede"> 16 </td>
      </tr>

      <tr>
        <th class="teache"> Memoria </th>
        <td class="tede"> 2 GB </td>
      </tr>

      <tr>
        <th class="teache"> Tipo memoria </th>
        <td class="tede"> GDDR5 a 6.24 GHz </td>
      </tr>

      <tr>
        <th class="teache"> Interfaz </th>
        <td class="tede"> 128 Bits </td>
      </tr>

      <tr>
        <th class="teache"> Dimensiones </th>
        <td class="tede"> 169.58 mm × 130.89 mm × 42.05 mm </td>
      </tr>

      <tr>
        <th class="teache"> Es Compatible Con DirectX </th>
        <td class="tede"> 12 </td>
      </tr>

      <tr>
        <th class="teache"> Es Compatible Con OpenGL </th>
        <td class="tede"> 4.4 </td>
      </tr>

      <tr>
        <th class="teache"> Información Adicional </th>
        <td class="tede"> * Los procesadores AMD de overclocking, incluyendo sin limitación, alterar las frecuencias/multiplicadores de reloj o el tiempo/voltaje de la memoria, para operar más allá de sus especificaciones de stock anularán la garantía del producto AMD aplicable, incluso cuando dicho overclocking esté habilitado a través del hardware y/o software de AMD. Esto puede anular las garantías ofrecidas por el fabricante del sistema o el minorista. Los usuarios asumen todos los riesgos y responsabilidades que pueden surgir del overclocking de los procesadores AMD, incluidos, sin limitación, fallos o daños en el hardware, menor rendimiento del sistema y / o pérdida de datos, corrupción o vulnerabilidad. </td>
      </tr>
