...
<head>
  ...
  <title>Unlimited Tecnhology - producto 90</title>
</head>
...
<!--**************************** FIN ---- HEADER    *************************************************-->
 ...
 <div class="especificartermino1">
     <h1> Musetex Gaming Pc Chasis Con 6 Ventiladores Led Argb </h1>
      
     <div class="producto">
        <img src="../imagenes/imagen90.png">
     </div>
<!-------------------------------- caja de informacion del producto ----------------------------->
<div class="info_producto">
          
    <div class="caja_precio">
      <p class="precio_viejo"> Precio Normal $ 500.000 </p>
      <p class="precio_especial"> Hoy $533.990 </p> 
      <a class="tarjeta" href=""><i class="far fa-credit-card"></i> Paga con tarjeta $ 500.000</a>
  ...
  <div class="detalles_producto">
    <p>      
  MUSETEX se ha comprometido a crear la marca mundial de la carcasa del ordenador. Tenemos una línea de productos completa. Se dedica principalmente al desarrollo, producción, ventas y servicio de carcasa de ordenador y sus componentes de PC de alta calidad.

MUSETEX insiste en que una empresa sin innovación es una empresa sin alma. Por lo tanto, la empresa se compromete a proporcionar a los clientes un diseño innovador avanzado, excelente calidad y excelente rendimiento. </p>
  </div>
 ...
 <!-------------------------------- Especificaciones del producto ----------------------------->
    <div class="tab-content">
      ...
      <tr>
        ...
        <td class="tede"> MUSETEX </td>
      </tr>
      
      <tr >
        <th class="teache"> Color </th>
        <td class="tede"> Ventiladores RGB PLUS 903-6 </td>
      </tr>

      <tr>
        <th class="teache"> Material </th>
        <td class="tede"> Vidrio templado </td>
      </tr>
      ...
      <tr>
        ...
        <td class="tede"> ¿soporte de placa madre? el espacioso interior se adapta a todas las configuraciones estándar de placas base e-atx, atx, micro-atx, mini-itx.
        *? excelente rendimiento de refrigeración? los ventiladores led argb de 6 x 120 mm preinstalados en la parte delantera, superior y trasera pueden proporcionar un flujo de aire considerable mientras mantienen frescos los sistemas más extremos.</td>
      </tr>
