	            ...
	            <P>
					<ul>
						<li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen70.webp">
							...
							<li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen74.webp">
							<h3>PC GAMER IMMORTALS CORE I5 9400F H310M SSD 240GB RAM 8GB</h3>
							<h4>$2.599.899</h4></li>
                            <li class="col col-sm-2"><img class="img-fluid" id="imagen" src="../imagenes/imagen75.webp">
