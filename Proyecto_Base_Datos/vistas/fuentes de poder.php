...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="../css/icono.css">  -->   
	...
	<title>Fuentes de Poder - Unlimited Tecnhology</title>
</head>
		    ...
		    <img id="til" src="../imagenes/tit-fuen.png" alt="fuentes de poder">
				<ul>
					...
					<li class="colimag"><img id="imagen" src="../imagenes/imagen115.jpg">
							...
							$990,900</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen116.jpg">	
							<p>Cooler Master V1200 Platinum Fuente De Poder<br>
							$699,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen117.jpg">	
							<p>Thermaltake Toughpower Grand Rgb 1200w Platinum Fuente Poder<br>
							$399,900</p>	</li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen118.jpg">	
							<p>Fuente De Poder Cougar 650 80 Plus Gold Modular<br>
							$699,000</p></li>
                </ul>           
