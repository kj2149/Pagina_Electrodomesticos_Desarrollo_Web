...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="../css/icono.css">  -->   
	...
	<title>Gabinetes - Unlimited Tecnhology</title>
</head>
		    ...
		    <img id="til" src="../imagenes/tit-gab.png" alt="gabinetes">
				...
				<ul>
					...
					<li class="colimag"><img id="imagen" src="../imagenes/imagen91.png">	
					    ...
					    $320,000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen93.png">	
					    <p>Chasis Caja Gamemax Rockstar 2 Gabinete Gaming Mid Tower Atx<br>
						$399.000</p></li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen94.png">	
					    <p>Caja Gabinete Gamer Rgb Aerocool Bolt Acril Ventilador 120<br>
						$279,900</p>	</li>
					<li class="colimag"><img id="imagen" src="../imagenes/imagen95.jpg">	
					    <p>Chasis De Torre C-570 Pink | Kediers<br>
						$1,009,000</p></li>
				</ul>
